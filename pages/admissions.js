            ...
            <div className="grid grid-cols-1 gap-5 my-2 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="mb-2">
                ...
                >
                  ...
                  <option value="CLA">Culinary Arts</option>
                  <option value="FOO">Front Office Operations</option>
                  <option value="HKL">Housekeeping and Laundry</option>
                  <option value="CPP">Computer Packages</option>
                </select>
              </div>
          ...
          <div className="mb-5">
            ...
            <div className="grid grid-cols-1 gap-5 my-2 mt-4 md:mt-0  lg:grid-cols-3">
              <div className="mb-2 md:mt-5 ">
                <Link
                  href="/"
                  className="md:text-lg lg:text-base text-sm sm:p-3 py-3 px-2 text-white transition-transform bg-red-500 rounded-lg active:scale-95 hover:bg-red-500/80"
                >
