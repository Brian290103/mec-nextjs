...
const Gallery = () => {
  ...
  const data = [
    ...
    {
      id: 7,
      imgUrl: '/upload_0b7a18fec1cb0a89c1e81699ef51a60d.png',
    },
    {
      id: 7,
      imgUrl: '/logoLodge.webp',
    ...
    <div className="relative  overflow-hidden ">
      ...
      <div className="px-2 py-3 ">
        ...
        <div className="grid grid-cols-8 gap-2">
          <div className="border lg:col-span-6 col-span-8">
            Images
          ...
          <div className="border col-span-2 hidden lg:block">Videos</div>
        </div>
      </div>
      {isOpen && (
        <div
